...
// GameDevelopment SDK netsim feature
...
class GameDevelopmentNetsimFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _simulate(GameDevelopmentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GameDevelopmentContext $ctx, array $applied): void
    {
        $client = $this->client;
