...
// GameDevelopment SDK ratelimit feature
...
class GameDevelopmentRatelimitFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _acquire(GameDevelopmentContext $ctx): void
    {
    ...
    private function _track(GameDevelopmentContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
