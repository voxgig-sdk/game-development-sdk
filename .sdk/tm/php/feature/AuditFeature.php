...
// GameDevelopment SDK audit feature
...
class GameDevelopmentAuditFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _emit(GameDevelopmentContext $ctx, string $outcome): void
    {
