...
// GameDevelopment SDK proxy feature
...
class GameDevelopmentProxyFeature extends GameDevelopmentBaseFeature
{
    ...
    public function init(GameDevelopmentContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GameDevelopmentContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
