...
// GameDevelopment SDK metrics feature
...
class GameDevelopmentMetricsFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _record(GameDevelopmentContext $ctx, bool $ok): void
    {
