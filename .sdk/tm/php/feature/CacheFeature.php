...
// GameDevelopment SDK cache feature
...
class GameDevelopmentCacheFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _through(GameDevelopmentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
