...
// GameDevelopment SDK utility: graphql
//
...
class GameDevelopmentGraphql
{
    ...
    // equivalent.
    public static function body(GameDevelopmentContext $ctx): mixed
    {
    ...
    public static function errors(GameDevelopmentContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
