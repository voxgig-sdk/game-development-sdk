...
// GameDevelopment SDK utility: fetcher

class GameDevelopmentFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GameDevelopmentSDK/1.0)';
    ...
    public static function call(GameDevelopmentContext $ctx, string $fullurl, array $fetchdef): array
    {
