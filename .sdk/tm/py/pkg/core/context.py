...
from projectname_sdk.core.control import GameDevelopmentControl
...
class GameDevelopmentContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = GameDevelopmentControl()
        ...
        if isinstance(sp, GameDevelopmentSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GameDevelopmentResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GameDevelopmentResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return GameDevelopmentOperation({})
    ...
    def make_error(self, code, msg):
        return GameDevelopmentError(code, msg, self)
