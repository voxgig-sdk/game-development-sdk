...
from projectname_sdk import GameDevelopmentSDK
from projectname_sdk.core.spec import GameDevelopmentSpec
from projectname_sdk.core.result import GameDevelopmentResult
from projectname_sdk.core.response import GameDevelopmentResponse
from projectname_sdk.core.operation import GameDevelopmentOperation
from projectname_sdk.core.error import GameDevelopmentError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GameDevelopmentBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GameDevelopmentError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except GameDevelopmentError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = GameDevelopmentResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = GameDevelopmentSDK.test(None, None)
        ...
        class TestInitFeature(GameDevelopmentBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GameDevelopmentBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = GameDevelopmentSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = GameDevelopmentSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GameDevelopmentSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GameDevelopmentSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = GameDevelopmentOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GameDevelopmentSDK.test(None, setup_opts)
