...
|---|---|---|
| `ts/` | @voxgig-sdk/game-development-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/game-development-sdk \
      --repository voxgig-sdk/game-development-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/game-development-sdk` shows it, and
`npm trust revoke @voxgig-sdk/game-development-sdk --id=<id>` removes it.
