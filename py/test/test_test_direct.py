...
class TestTestDirect:
    ...
    def test_should_direct_list_test(self):
        setup = _test_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-test", "live" if setup["live"] else "unit")
        if _skip:
