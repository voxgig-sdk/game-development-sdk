# GameDevelopment SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GameDevelopmentSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GameDevelopmentSDK(...) and GameDevelopmentSDK.test(...) become
#      GameDevelopmentSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gamedevelopment_sdk"
_SDK_CLASS = "GameDevelopmentSDK"
