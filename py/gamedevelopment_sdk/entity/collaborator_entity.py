...
class CollaboratorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CollaboratorEntity(self._client, opts)
    ...
    def data_get(self) -> Collaborator:
    ...
    def match_get(self) -> Collaborator:
    ...
    def create(self, reqdata: CollaboratorCreateData, ctrl=None) -> Collaborator:
        utility = self._utility
