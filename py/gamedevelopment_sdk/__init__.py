...
from gamedevelopment_sdk.utility import register

# Load features
from gamedevelopment_sdk.feature.base_feature import GameDevelopmentBaseFeature
from gamedevelopment_sdk.features import _has_feature, _make_feature
...
class GameDevelopmentSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GameDevelopmentSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from gamedevelopment_sdk.entity.analytics_entity import AnalyticsEntity
    ...
    def Asset(self, data=None) -> "AssetEntity":
        ...
        from gamedevelopment_sdk.entity.asset_entity import AssetEntity
        return AssetEntity(self, data)


    def Build(self, data=None) -> "BuildEntity":
        """Entity factory: client.Build().list() / client.Build().load({"id": ...})."""
        from gamedevelopment_sdk.entity.build_entity import BuildEntity
    ...
    def Collaboration(self, data=None) -> "CollaborationEntity":
        ...
        from gamedevelopment_sdk.entity.collaboration_entity import CollaborationEntity
    ...
    def Collaborator(self, data=None) -> "CollaboratorEntity":
        ...
        from gamedevelopment_sdk.entity.collaborator_entity import CollaboratorEntity
    ...
    def Deployment(self, data=None) -> "DeploymentEntity":
        ...
        from gamedevelopment_sdk.entity.deployment_entity import DeploymentEntity
    ...
    def Project(self, data=None) -> "ProjectEntity":
        ...
        from gamedevelopment_sdk.entity.project_entity import ProjectEntity
        return ProjectEntity(self, data)


    def Test(self, data=None) -> "TestEntity":
        """Entity factory: client.Test().list() / client.Test().load({"id": ...})."""
        from gamedevelopment_sdk.entity.test_entity import TestEntity
