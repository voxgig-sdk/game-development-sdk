...
local function make_error_util(ctx, err)
  ...
  local msg = "GameDevelopmentSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = GameDevelopmentError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == GameDevelopmentError then
