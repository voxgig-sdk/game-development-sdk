...
describe("TestEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GAMEDEVELOPMENT_TEST_TEST_ENTID JSON to run live")
      return
    end
...
function test_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GAMEDEVELOPMENT_TEST_TEST_ENTID")
