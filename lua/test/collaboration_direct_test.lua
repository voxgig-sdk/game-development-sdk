...
describe("CollaborationDirect", function()
  it("should direct-list-collaboration", function()
    local setup = collaboration_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-collaboration", setup.live and "live" or "unit")
...
function collaboration_direct_setup(mockres)
