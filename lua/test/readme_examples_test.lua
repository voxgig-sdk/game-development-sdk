...
local SDK_MODULE = "game-development_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["analytics"] = { ["test01"] = { id = "test01" } }, ["asset"] = { ["test01"] = { id = "test01" } }, ["build"] = { ["test01"] = { id = "test01" } }, ["collaboration"] = { ["test01"] = { id = "test01" } }, ["collaborator"] = { ["test01"] = { id = "test01" } }, ["deployment"] = { ["test01"] = { id = "test01" } }, ["project"] = { ["test01"] = { id = "test01" } }, ["test"] = { ["test01"] = { id = "test01" } } } }'
