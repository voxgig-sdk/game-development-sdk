...
describe("AnalyticsDirect", function()
  it("should direct-list-analytics", function()
    local setup = analytics_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-analytics", setup.live and "live" or "unit")
