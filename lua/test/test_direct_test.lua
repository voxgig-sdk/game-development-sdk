...
describe("TestDirect", function()
  it("should direct-list-test", function()
    local setup = test_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-test", setup.live and "live" or "unit")
