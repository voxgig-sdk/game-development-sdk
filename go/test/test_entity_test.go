...
func TestTestEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		...
		var seen []any
		for item := range base.Test(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.Test(nil).Stream("list", nil, nil) {
...
func testBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GAME_DEVELOPMENT_TEST_TEST_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GAME_DEVELOPMENT_TEST_TEST_ENTID"])
