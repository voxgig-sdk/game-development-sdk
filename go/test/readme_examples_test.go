...
const testSeed = `map[string]any{"entity": map[string]any{"analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "asset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "build": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collaboration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collaborator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deployment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "test": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
