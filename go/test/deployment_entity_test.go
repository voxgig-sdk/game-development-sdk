...
func TestDeploymentEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GAME_DEVELOPMENT_TEST_DEPLOYMENT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func deploymentBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GAME_DEVELOPMENT_TEST_DEPLOYMENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GAME_DEVELOPMENT_TEST_DEPLOYMENT_ENTID"])
