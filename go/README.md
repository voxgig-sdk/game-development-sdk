...
The Golang SDK for the GameDevelopment API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/game-development-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/game-development-sdk=../path/to/github.com/voxgig-sdk/game-development-sdk
```
...
```
github.com/voxgig-sdk/game-development-sdk/
...
The root package (`github.com/voxgig-sdk/game-development-sdk`) re-exports everything needed
