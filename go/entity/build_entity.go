...
func NewBuildEntity(client *core.GameDevelopmentSDK, entopts map[string]any) *BuildEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BuildEntity) GetName() string { return e.name }
...
func (e *BuildEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BuildEntity) Deleted() bool {
	return e.deleted
}


func (e *BuildEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBuildEntity(e.client, opts)
}

func (e *BuildEntity) Data(args ...any) any {
...
func (e *BuildEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Build; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BuildEntity) DataTyped(data ...Build) Build {
	if len(data) > 0 {
		return typedFrom[Build](e.Data(asMap(data[0])))
	}
	return typedFrom[Build](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Build (all fields
// optional at the wire level).
func (e *BuildEntity) MatchTyped(match ...Build) Build {
	if len(match) > 0 {
		return typedFrom[Build](e.Match(asMap(match[0])))
	}
	return typedFrom[Build](e.Match())
}
...
func (e *BuildEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BuildEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BuildEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BuildEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BuildCreateData and returns an Build. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BuildEntity) CreateTyped(reqdata BuildCreateData, ctrl map[string]any) (Build, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Build{}, err
	}
	return typedFrom[Build](res), nil
}



func (e *BuildEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BuildEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BuildEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
