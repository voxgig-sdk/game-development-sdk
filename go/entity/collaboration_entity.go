...
func NewCollaborationEntity(client *core.GameDevelopmentSDK, entopts map[string]any) *CollaborationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollaborationEntity) GetName() string { return e.name }
...
func (e *CollaborationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CollaborationEntity) Deleted() bool {
	return e.deleted
}


func (e *CollaborationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCollaborationEntity(e.client, opts)
}

func (e *CollaborationEntity) Data(args ...any) any {
...
func (e *CollaborationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CollaborationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CollaborationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *CollaborationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CollaborationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CollaborationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *CollaborationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
