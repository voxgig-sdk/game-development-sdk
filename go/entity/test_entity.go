...
func NewTestEntity(client *core.GameDevelopmentSDK, entopts map[string]any) *TestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TestListMatch and returns []Test. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TestEntity) ListTyped(reqmatch TestListMatch, ctrl map[string]any) ([]Test, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Test](res), nil
}
