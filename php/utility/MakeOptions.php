...
// GameDevelopment SDK utility: make_options

class GameDevelopmentMakeOptions
{
    ...
    public static function call(GameDevelopmentContext $ctx): array
    {
        ...
        //
        // `GameDevelopmentSchema::optspec()` is built from the model:
        ...
        $optspec = GameDevelopmentSchema::optspec();
