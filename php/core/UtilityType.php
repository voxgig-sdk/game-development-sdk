...
// GameDevelopment SDK utility type

class GameDevelopmentUtility
{
    ...
    public static function copy(GameDevelopmentUtility $src): GameDevelopmentUtility
    {
        $u = new GameDevelopmentUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
