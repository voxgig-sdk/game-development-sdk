...
// GameDevelopment SDK Build entity
...
class BuildEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BuildEntity($this->_client, $opts);
    }

    /**
     * @param Build|array $args Build data (assoc-array) to store.
     */
    ...
    /**
     * @return Build|array The current Build data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Build fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Build fields).
     */
     ...
     * Create a new Build.
     *
     * @param BuildCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BuildCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Build|array The created Build as an assoc-array at the
