...
// GameDevelopment SDK Collaborator entity
...
class CollaboratorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CollaboratorEntity($this->_client, $opts);
    }

    /**
     * @param Collaborator|array $args Collaborator data (assoc-array) to store.
     */
    ...
    /**
     * @return Collaborator|array The current Collaborator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Collaborator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Collaborator fields).
     */
     ...
     *
     * @param CollaboratorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CollaboratorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Collaborator|array The created Collaborator as an assoc-array at the
