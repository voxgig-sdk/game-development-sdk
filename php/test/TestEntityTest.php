...
class TestEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Test_(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Test_(null)->stream("list", null, null) as $item) {
...
function test_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["test01", "test02", "test03", "project01", "project02", "project03"] as $k) {
