...
// GameDevelopment SDK pipeline test
//
...
{
    private static function utility(): GameDevelopmentUtility
    {
        return new GameDevelopmentUtility();
    }
    ...
    private static function ctx(array $over = []): GameDevelopmentContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GameDevelopmentContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GameDevelopmentOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GameDevelopmentError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GameDevelopmentOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GameDevelopmentMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GameDevelopmentOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GameDevelopmentMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GameDevelopmentOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GameDevelopmentMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameDevelopmentSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GameDevelopmentMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GameDevelopmentResponse([]),
            'result' => new GameDevelopmentResult([]),
        ]);
        [, $err] = GameDevelopmentMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec([]),
            'response' => null,
            'result' => new GameDevelopmentResult([]),
        ]);
        [, $err] = GameDevelopmentMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec(['step' => 's']),
            'response' => new GameDevelopmentResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GameDevelopmentResult([]),
        ]);
        [, $err] = GameDevelopmentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec(['step' => 's']),
            'response' => new GameDevelopmentResponse(self::resp(200, ['v' => 1])),
            'result' => new GameDevelopmentResult([]),
        ]);
        [, $err] = GameDevelopmentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec(['step' => 's']),
            'response' => new GameDevelopmentResponse(self::resp(200, ['v' => 2])),
            'result' => new GameDevelopmentResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GameDevelopmentMakeResponse::call($ctx);
    ...
    {
        $preset = new GameDevelopmentResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec([]),
            'response' => new GameDevelopmentResponse([]),
            'result' => new GameDevelopmentResult([]),
        ...
        [$got, $err] = GameDevelopmentMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GameDevelopmentResult([])]);
        [, $err] = GameDevelopmentMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GameDevelopmentSpec([]), 'result' => null]);
        [, $err] = GameDevelopmentMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameDevelopmentSpec(['step' => 's']),
            'result' => new GameDevelopmentResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GameDevelopmentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameDevelopmentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GameDevelopmentSpec(['step' => 's']),
            'result' => new GameDevelopmentResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GameDevelopmentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GameDevelopmentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GameDevelopmentResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GameDevelopmentSpec([]),
            'result' => new GameDevelopmentResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GameDevelopmentMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameDevelopmentMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GameDevelopmentError('boom', 'boom');
        $utility->fetcher = function (GameDevelopmentContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameDevelopmentSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GameDevelopmentMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GameDevelopmentContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GameDevelopmentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GameDevelopmentResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        GameDevelopmentMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GameDevelopmentContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GameDevelopmentSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GameDevelopmentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GameDevelopmentResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GameDevelopmentSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GameDevelopmentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GameDevelopmentMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GameDevelopmentMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GameDevelopmentResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GameDevelopmentDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GameDevelopmentResult(['ok' => false])]);
        $this->expectException(GameDevelopmentError::class);
        GameDevelopmentDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GameDevelopmentResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GameDevelopmentMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        GameDevelopmentMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GameDevelopmentBaseFeature();
        $b = new GameDevelopmentBaseFeature();
        GameDevelopmentFeatureAdd::call($ctx, $a);
        GameDevelopmentFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GameDevelopmentBaseFeature
    {
        $f = new GameDevelopmentBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GameDevelopmentFeatureAdd::call($ctx, self::named_feature('a'));
        GameDevelopmentFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        GameDevelopmentFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        GameDevelopmentFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        GameDevelopmentFeatureAdd::call($ctx, $replace);
        ...
        GameDevelopmentFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GameDevelopmentContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GameDevelopmentSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GameDevelopmentPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        GameDevelopmentPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GameDevelopmentResponse(['headers' => null]),
            'result' => new GameDevelopmentResult([]),
        ]);
        GameDevelopmentResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        GameDevelopmentResultBody::call($ctx);
