...
class CollaborationDirectTest extends TestCase
{
    public function test_direct_list_collaboration(): void
    {
        $setup = collaboration_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-collaboration", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
