...
class BuildEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GAMEDEVELOPMENT_TEST_BUILD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function build_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GAMEDEVELOPMENT_TEST_BUILD_ENTID");
