...
class AssetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GAMEDEVELOPMENT_TEST_ASSET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function asset_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GAMEDEVELOPMENT_TEST_ASSET_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["GAMEDEVELOPMENT_TEST_ASSET_ENTID"]);
