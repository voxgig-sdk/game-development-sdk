...
// GameDevelopment SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GameDevelopmentOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GameDevelopmentOmni::structfix($now, Struct::undef()))
                        !== json_encode(GameDevelopmentOmni::structfix($val, Struct::undef()))) {
