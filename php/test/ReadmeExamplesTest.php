...
// GameDevelopment SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GameDevelopmentSDK::test)
...
{
    private const SDK_CLASS = 'GameDevelopmentSDK';
    ...
    private const SDK_BASE = 'gamedevelopment_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../gamedevelopment_sdk.php';
