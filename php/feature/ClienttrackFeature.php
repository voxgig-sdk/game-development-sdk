...
// GameDevelopment SDK clienttrack feature
...
class GameDevelopmentClienttrackFeature extends GameDevelopmentBaseFeature
{
    ...
    public function PostConstruct(GameDevelopmentContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GameDevelopment-SDK';
