...
// GameDevelopment SDK streaming feature
...
class GameDevelopmentStreamingFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _iterate(GameDevelopmentResult $result): \Generator
    {
    ...
    private function _streamable(GameDevelopmentContext $ctx): bool
    {
