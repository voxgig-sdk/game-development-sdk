...
// GameDevelopment SDK rbac feature
...
class GameDevelopmentRbacFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _required(GameDevelopmentContext $ctx): ?string
    {
    ...
    private function _reject(GameDevelopmentContext $ctx, string $required): void
    {
    ...
    private function _track(GameDevelopmentContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
