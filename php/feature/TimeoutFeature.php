...
// GameDevelopment SDK timeout feature
...
class GameDevelopmentTimeoutFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _with_timeout(GameDevelopmentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GameDevelopmentContext $_ctx, float $ms): void
    {
        $client = $this->client;
