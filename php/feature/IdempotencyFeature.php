...
// GameDevelopment SDK idempotency feature
...
class GameDevelopmentIdempotencyFeature extends GameDevelopmentBaseFeature
{
    ...
    private function _mutating(GameDevelopmentContext $ctx): bool
    {
