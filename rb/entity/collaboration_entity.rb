...
class CollaborationEntity
  ...
  def make
    opts = @_entopts.dup
    CollaborationEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CollaborationListMatch, Hash, nil] match filter (any subset of
  #   Collaboration fields); defaults to nil, treated as an empty match that lists all.
