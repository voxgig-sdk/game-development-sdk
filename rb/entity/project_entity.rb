# GameDevelopment SDK Project entity
...
class ProjectEntity
  ...
  #
  # @param reqmatch [ProjectListMatch, Hash, nil] match filter (any subset of
  #   Project fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
