...
class DeploymentEntity
  ...
  #   as an empty match, so client.Deployment.load works with no args).
  ...
  #
  # @param reqmatch [DeploymentListMatch, Hash, nil] match filter (any subset of
  #   Deployment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
