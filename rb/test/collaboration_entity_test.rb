...
class CollaborationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GAME_DEVELOPMENT_TEST_COLLABORATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def collaboration_basic_setup(extra)
  ...
  entid_env_raw = ENV["GAME_DEVELOPMENT_TEST_COLLABORATION_ENTID"]
