...
#      offline in seeded test mode (GameDevelopmentSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GameDevelopment_sdk.rb")
  SDK_CLASS = "GameDevelopmentSDK"
