...
func registerSDKWords(r *eng.Registry, client *sdk.GameDevelopmentSDK) {
...
func runOp(client *sdk.GameDevelopmentSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
