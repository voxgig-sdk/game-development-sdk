...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/game-development` | `npm install @voxgig-sdk/game-development` |
| Python | `voxgig-sdk-game-development` | `pip install voxgig-sdk-game-development` |
| PHP | `voxgig-sdk/game-development` | `composer require voxgig-sdk/game-development` |
| Golang | `github.com/voxgig-sdk/game-development-sdk/go` | `go get github.com/voxgig-sdk/game-development-sdk/go` |
| Ruby | `voxgig-sdk-game-development` | `gem install voxgig-sdk-game-development` |
| Lua | `voxgig-sdk-game-development` | `luarocks install voxgig-sdk-game-development` |
