// Command GameDevelopment-mcp is an MCP server exposing the GameDevelopment
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GameDevelopment_list  — list records of an entity
//	GameDevelopment_load  — load a single record of an entity
//
