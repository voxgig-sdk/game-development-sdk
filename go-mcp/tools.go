...
type Args struct {
	Entity string         `json:"entity" jsonschema:"analytics | asset | build | collaboration | collaborator | deployment | project | test"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GameDevelopmentSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-development_list",
		Description: "List records from GameDevelopment. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "game-development_load",
		Description: "Load a single record from GameDevelopment. " +
...
func runOp(client *sdk.GameDevelopmentSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GameDevelopmentSDK, name string) (sdk.GameDevelopmentEntity, error) {
