...
class CollaborationEntity extends GameDevelopmentEntityBase<Collaboration> {
  ...
  async list(this: any, reqmatch?: CollaborationListMatch, ctrl?: Control): Promise<CollaborationEntity[]> {
  ...
  async remove(
    this: any, reqmatch?: CollaborationRemoveMatch, ctrl?: Control,
