...
function envOverride(m) {
    if ('TRUE' === process.env.GAME_DEVELOPMENT_TEST_LIVE ||
        'TRUE' === process.env.GAME_DEVELOPMENT_TEST_OVERRIDE) {
    ...
    m.GAME_DEVELOPMENT_TEST_EXPLAIN = process.env.GAME_DEVELOPMENT_TEST_EXPLAIN || m.GAME_DEVELOPMENT_TEST_EXPLAIN;
    return m;
}
