...
(0, node_test_1.describe)('AnalyticsEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // LIST
        const analytics_ref01_match = {};
        analytics_ref01_match['project_id'] = setup.idmap['project01'];
        const analytics_ref01_list = (await analytics_ref01_ent.list(analytics_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['analytics01', 'analytics02', 'analytics03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
