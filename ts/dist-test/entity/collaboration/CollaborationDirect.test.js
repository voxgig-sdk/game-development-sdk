...
(0, node_test_1.describe)('CollaborationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-collaboration', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-collaboration', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GAME_DEVELOPMENT_TEST_COLLABORATION_ENTID'];
...
//# sourceMappingURL=CollaborationDirect.test.js.map