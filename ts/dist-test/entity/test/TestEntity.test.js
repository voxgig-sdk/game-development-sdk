...
(0, node_test_1.describe)('TestEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GAME_DEVELOPMENT_TEST_TEST_ENTID JSON to run live');
            return;
        }
        ...
        // LIST
        const test_ref01_match = {};
        test_ref01_match['project_id'] = setup.idmap['project01'];
        const test_ref01_list = (await test_ref01_ent.list(test_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(test_ref01_list, { id: test_ref01_data.id })));
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['test01', 'test02', 'test03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['GAME_DEVELOPMENT_TEST_TEST_ENTID'];
