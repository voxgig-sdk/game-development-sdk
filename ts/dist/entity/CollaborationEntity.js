...
exports.CollaborationEntity = void 0;
const GameDevelopmentEntityBase_1 = require("../GameDevelopmentEntityBase");
// TODO: needs Entity superclass
class CollaborationEntity extends GameDevelopmentEntityBase_1.GameDevelopmentEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'collaboration';
        this.name_ = 'collaboration';
        this.Name = 'Collaboration';
    }
    make() {
        return new CollaborationEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Off-happy-path (throw disabled): typed as any so the method's
                // Promise<CollaborationEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CollaborationEntity = CollaborationEntity;
//# sourceMappingURL=CollaborationEntity.js.map