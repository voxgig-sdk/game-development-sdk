...
class CollaboratorEntity extends GameDevelopmentEntityBase_1.GameDevelopmentEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'collaborator';
        this.name_ = 'collaborator';
        this.Name = 'Collaborator';
    }
    make() {
        return new CollaboratorEntity(this._client, this.entopts());
    }
...
//# sourceMappingURL=CollaboratorEntity.js.map