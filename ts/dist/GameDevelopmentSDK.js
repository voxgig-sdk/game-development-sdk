...
exports.SDK = exports.GameDevelopmentSDK = exports.GameDevelopmentEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const AnalyticsEntity_1 = require("./entity/AnalyticsEntity");
const AssetEntity_1 = require("./entity/AssetEntity");
const BuildEntity_1 = require("./entity/BuildEntity");
...
const GameDevelopmentEntityBase_1 = require("./GameDevelopmentEntityBase");
Object.defineProperty(exports, "GameDevelopmentEntityBase", { enumerable: true, get: function () { return GameDevelopmentEntityBase_1.GameDevelopmentEntityBase; } });
...
class GameDevelopmentSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('GameDevelopmentSDK: graphql: ' +
    ...
    Build(entopts) {
        const self = this;
        return new BuildEntity_1.BuildEntity(self, entopts);
    }
...
exports.GameDevelopmentSDK = GameDevelopmentSDK;
const SDK = GameDevelopmentSDK;
exports.SDK = SDK;
//# sourceMappingURL=GameDevelopmentSDK.js.map